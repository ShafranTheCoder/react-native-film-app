...
export default createDrawerNavigator(
    ...
    Screen1: {
      ...
      navigationOptions: {
        ...
        drawerIcon: ({tintColor}) => (
          <MaterialIcon name="grade" size={24} style={{color: tintColor}} />
        ),
      },
    },
    Screen2: {
      ...
      navigationOptions: {
        drawerLabel: 'Batman',
        drawerIcon: ({tintColor}) => (
          <MaterialIcon name="favorite" size={24} style={{color: tintColor}} />
        ),
      },
    },
    Screen3: {
      ...
      navigationOptions: {
        ...
        drawerIcon: ({tintColor}) => (
          <MaterialIcon name="pets" size={24} style={{color: tintColor}} />
        ),
      },
    },
  },
  {
    ...
    contentOptions: {
      ...
      itemsContainerStyle: {marginVertical: 65},
    },
  },
);
